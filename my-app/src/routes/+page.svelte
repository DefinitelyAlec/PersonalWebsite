...
<div id="EmailGitHubContainer" class="flex justify-around">
  <a title="Email" href="mailto:alecparent@rocketmail.com">
    <div id="EmailContainer" class="btn btn-ghost large-icon h-28">
      <MdiEmailOutline />
    </div>
  </a>
  <a
    ...
    href="https://github.com/DefinitelyAlec"
  >
    <div id="GitHubContainer" class="btn btn-ghost large-icon h-28">
      <MdiGithub />
    </div>
  </a>
</div>
...
<div id="ProjectContainer" class="pt-24">
  ...
  <div class="btnContainer">
    <button
      ...
      on:click={() => manipulateDropdowns("dropdown-input", true)}
      >Open All</button
    >
    ...
    <!-- <button
    class="btn">
    <svg xmlns="http://www.w3.org/2000/svg" height="0.85em" viewBox="0 0 24 24" {...$$props}>
